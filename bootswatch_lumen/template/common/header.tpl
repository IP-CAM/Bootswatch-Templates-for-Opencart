...
<link href="catalog/view/theme/bootswatch_lumen/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
  ...
  <div class="container" style="padding-top:10px;">
    ...
    <div id="top-links" class="nav pull-right" >
      <ul class="list-inline">
        <li><a href="<?php echo $contact; ?>"><i class="fa fa-phone"></i> </a> <span class="hidden-xs hidden-sm hidden-md"><?php echo $telephone; ?> fhfghfgh</span></li>
    ...
    <div class="row" style="margin-bottom: 10px;">
      <div class="col-sm-5">
        <div id="logo">
          ...
          <?php } else { ?>
          <h1><a href="<?php echo $home; ?>"><i class="fa fa-file-image-o"></i> <?php echo $name; ?></a></h1>
          <?php } ?>
        </div>
      </div>
